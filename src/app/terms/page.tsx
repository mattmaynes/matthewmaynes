  ...
  return (
    <section className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
      ...
      <p className="mt-6 text-body text-text-muted">
        This is my personal site. I write everything on it and I take the photographs and
        video myself or with my family. This page explains what you may do with that, what
        you may not, and how to ask if you want to do something else.
      </p>
      ...
      <section className="mt-12">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-body text-text-muted">
          ...
          <li>
            ...
            kind a review or a citation makes.
          </li>
      ...
      <section className="mt-12">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-body text-text-muted">
          ...
          <li>
            Reproduce the <strong className="font-semibold text-text">photographs or video</strong>{" "}
      ...
      <section className="mt-12">
        ...
        <p className="mt-3 text-body text-text-muted">
          ...
          building a dataset, exclude them.
        </p>
        <p className="mt-3 text-body text-text-muted">
      ...
      <section className="mt-12">
        ...
        <p className="mt-3 text-body text-text-muted">
          ...
          media, and the repository&apos;s licence file spells out which directories are which.
        </p>
      </section>
